        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="https://github.com/Silen01"><i
                            class="icon-home icon-white"></i>我的github <span class="sml_t">！</span></a>
                        ...
                        <#else>
                            ...
                            <#if user??>
                                <li><a href="#post" title="灌水" data-toggle="modal"
                                       ...
                                       onclick="javascript:addz();document.getElementById('submenu').innerHTML='灌水'">发帖子</a>
                                </li>
                            </#if>
                                <li class="divider"></li>
            ...
            statusCode:{
                200:function(data){
                    ...
                    $(data).each(function(index){
                        ...
                        $.bootstrapGrowl("你的【" + data[index].txt + "】被人回帖了！", {
                            type: 'danger',
                            width: 'auto',
                            allow_dismiss: false
                        });
