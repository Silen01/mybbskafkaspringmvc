            ...
            <form method="post" action="/user/reg" name="File_form"
                ...
                <div class="formRow">
                    <div class="control-group formSep">
                        ...
                        <div class="controls">
                            <div class="alert alert-info">
                                <label for="u_fname" class="control-label">填写账号</label> <input
                ...
                <div class="formRow">
                    <div class="control-group formSep">
                        ...
                        <div class="controls">
                            <div class="alert alert-info">
                                <label for="u_fname" class="control-label">填写密码</label>
                                ...
                                <div class="row-fluid">
                                    <div class="span10">
                                        ...
                                        <strong>密码</strong>最少6位，最大100位，为了安全请设置不易被破解的！
                ...
                <div class="formRow">
                    <div class="control-group formSep">
                        ...
                        <div class="controls">
                            <div class="alert alert-info">
                                <label for="u_fname" class="control-label">请再次填写密码</label>
                                <div class="sepH_b">
