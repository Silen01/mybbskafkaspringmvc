package com.liu.bbs.service;

import com.alibaba.fastjson.JSON;
import com.liu.bbs.dao.IUserDAO;
import com.liu.bbs.po.Bbsuser;
import com.liu.bbs.po.Message;
import com.liu.bbs.service.kafka.consumer.MsgConsumer;
...
public Bbsuser uploadPic(MultipartHttpServletRequest req, CommonsMultipartResolver commonsMultipartResolver){//上传头像
    ...
    if(commonsMultipartResolver.isMultipart(req)){
        ...
        if(types.containsKey(type)){//符合
            ...
            File targetFile=new File("d:/P17/upload"+File.separator+req.getSession().getId()+types.get(type));
