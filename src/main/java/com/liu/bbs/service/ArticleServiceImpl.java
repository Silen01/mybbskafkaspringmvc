...
import com.liu.bbs.dao.ArticleDAOImpl;
import com.liu.bbs.dao.IArticleDAO;
import com.liu.bbs.po.Article;
import com.liu.bbs.service.kafka.producer.MsgProducer;
...
public class ArticleServiceImpl {
    ...
    public String uploadPic(HttpServletRequest req){//上传t图片
        ...
        if(commonsMultipartResolver.isMultipart(req)){
            ...
            MultipartFile file=request.getFile("img");//上传组建的名字。
